...
public class DeactivateEmp extends JFrame implements ActionListener {
	JButton button;
	JButton button1;
	JLabel label;
	//JPanel panel;
	...
	ResultSet rs;
	JScrollPane sp;
public void deactiveEmp() {
	setLayout(new BorderLayout());
	
	button1=new JButton("Deactivate");
	...
	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	 ...
	 rs=new EmployeeController().deactive();
