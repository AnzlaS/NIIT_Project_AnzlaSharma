...
public class Changeskills extends JFrame implements ActionListener{
...
public void actionPerformed(ActionEvent e) {
	...
	String skil=textField.getText();
	String message= new EmployeeController().Empskil(skil);
